        ...
        <div class="form-stack">
            <div class="form-group">
                ...
                <select name="tipo" id="tipo" class="{{ $errors->has('tipo') ? 'is-invalid' : '' }}">
                    ...
                    <option value="socio"   {{ old('tipo') === 'socio'   ? 'selected' : '' }}>Socio</option>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre" id="nombre"
                    value="{{ old('nombre') }}" placeholder="Ej: Transportes del Sur S.A.S"
            ...
            <div class="form-group">
                ...
                <input type="text" name="cedula_nit" id="cedula_nit"
                    value="{{ old('cedula_nit') }}" placeholder="Ej: 900123456-1"
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email"
                    value="{{ old('email') }}" placeholder="Ej: contacto@empresa.com"
