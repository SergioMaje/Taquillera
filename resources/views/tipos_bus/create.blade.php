...
@section('title', 'Nuevo Tipo de Bus')
...
<div class="page-header">
    ...
    <h1>Nuevo Tipo de Bus</h1>
</div>

<div class="form-card">
    <form method="POST" action="{{ route('tipos-bus.store') }}">
        @csrf
        ...
        <div class="form-stack">
            <div class="form-group">
                ...
                <input type="text" name="nombre" id="nombre"
                    value="{{ old('nombre') }}" placeholder="Ej: Ejecutivo, Climatizado..."
            ...
            <div class="form-group">
                ...
                <input type="text" name="descripcion" id="descripcion"
                    value="{{ old('descripcion') }}" placeholder="Descripción breve del tipo"
        ...
        <div class="checkbox-group">
            <label class="checkbox-label">
                <input type="checkbox" name="tiene_bano" value="1" {{ old('tiene_bano') ? 'checked' : '' }}>
                Tiene baño
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="tiene_tv" value="1" {{ old('tiene_tv') ? 'checked' : '' }}>
                Tiene TV
            </label>
            <label class="checkbox-label">
                <input type="checkbox" name="doble_piso" value="1" {{ old('doble_piso') ? 'checked' : '' }}>
                Doble piso
            </label>
        </div>
            ...
            <div style="display:flex; gap:16px;">
                <div class="form-group" style="flex:1">
                    ...
                    <input type="number" name="columnas_izquierda" id="columnas_izquierda"
                           min="1" max="3" value="{{ old('columnas_izquierda', 2) }}" required
                ...
                <div class="form-group" style="flex:1">
                    ...
                    <input type="number" name="columnas_derecha" id="columnas_derecha"
                           min="1" max="3" value="{{ old('columnas_derecha', 2) }}" required
                ...
                <div class="form-group" style="flex:1">
                    ...
                    <input type="number" name="capacidad_default" id="capacidad_default"
                           min="1" max="80" value="{{ old('capacidad_default') }}" placeholder="Ej: 40"
        ...
        <div class="form-actions">
            <button type="submit" class="btn-primary">Crear Tipo</button>
